...
gtk_cifro_scope_object_constructed (GObject *object)
{
  ...
  priv->scope_renderer = gtk_cifro_scope_renderer_new (GTK_CIFRO_AREA (cscope));
...
gtk_cifro_scope_object_finalize (GObject *object)
{
  ...
  g_object_unref (cscope->priv->scope_renderer);
                               ...
                               GtkCifroScopePrivate *priv)
{
  ...
  gtk_cifro_area_state_get_border (priv->state,
                               ...
                               gboolean       show)
{
  ...
  gtk_cifro_scope_renderer_set_info_show (cscope->priv->scope_renderer, show);
  gtk_cifro_area_update (GTK_CIFRO_AREA (cscope));
}
                               ...
                               const gchar   *value_axis_name)
{
  ...
  gtk_cifro_scope_renderer_set_axis_name (cscope->priv->scope_renderer,
                                          time_axis_name, value_axis_name);
  gtk_cifro_area_update (GTK_CIFRO_AREA (cscope));
}
...
gtk_cifro_scope_add_channel (GtkCifroScope *cscope)
{
  ...
  return gtk_cifro_scope_renderer_add_channel (cscope->priv->scope_renderer);
}
                                ...
                                gpointer       channel_id)
{
  ...
  gtk_cifro_scope_renderer_remove_channel (cscope->priv->scope_renderer, channel_id);
  gtk_cifro_area_update (GTK_CIFRO_AREA (cscope));
}
                                  ...
                                  const gchar   *axis_name)
{
  ...
  gtk_cifro_scope_renderer_set_channel_name (cscope->priv->scope_renderer,
                                             channel_id, axis_name);
  gtk_cifro_area_update (GTK_CIFRO_AREA (cscope));
}
                                        ...
                                        gfloat         time_step)
{
  ...
  gtk_cifro_scope_renderer_set_channel_time_param (cscope->priv->scope_renderer,
                                                   channel_id, time_shift, time_step);
  gtk_cifro_area_update (GTK_CIFRO_AREA (cscope));
}
                                         ...
                                         gfloat         value_scale)
{
  ...
  gtk_cifro_scope_renderer_set_channel_value_param (cscope->priv->scope_renderer,
                                                    channel_id, value_shift, value_scale);
  gtk_cifro_area_update (GTK_CIFRO_AREA (cscope));
}
                                       ...
                                       GtkCifroScopeDrawType  draw_type)
{
  ...
  gtk_cifro_scope_renderer_set_channel_draw_type (cscope->priv->scope_renderer,
                                                  channel_id, draw_type);
  gtk_cifro_area_update (GTK_CIFRO_AREA (cscope));
}
                                   ...
                                   gdouble        blue)
{
  ...
  gtk_cifro_scope_renderer_set_channel_color (cscope->priv->scope_renderer,
                                              channel_id, red, green, blue);
  gtk_cifro_area_update (GTK_CIFRO_AREA (cscope));
}
                                  ...
                                  gfloat        *values)
{
  ...
  gtk_cifro_scope_renderer_set_channel_data (cscope->priv->scope_renderer,
                                             channel_id, num, values);
}
                                  ...
                                  gboolean       show)
{
  ...
  gtk_cifro_scope_renderer_set_channel_show (cscope->priv->scope_renderer,
                                             channel_id, show);
  gtk_cifro_area_update (GTK_CIFRO_AREA (cscope));
}
...
void
gtk_cifro_scope_update (GtkCifroScope *cscope)
{
  g_return_if_fail (GTK_IS_CIFRO_SCOPE (cscope));

  gtk_cifro_scope_renderer_update (cscope->priv->scope_renderer);
  gtk_cifro_area_update (GTK_CIFRO_AREA (cscope));
}
