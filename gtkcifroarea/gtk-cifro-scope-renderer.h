...
#ifndef __GTK_CIFRO_SCOPE_RENDERER_H__
#define __GTK_CIFRO_SCOPE_RENDERER_H__
...
typedef struct _GtkCifroScopeRenderer GtkCifroScopeRenderer;
typedef struct _GtkCifroScopeRendererPrivate GtkCifroScopeRendererPrivate;
typedef struct _GtkCifroScopeRendererClass GtkCifroScopeRendererClass;

struct _GtkCifroScopeRenderer
{
...
struct _GtkCifroScopeRendererClass
{
...
GtkCifroScopeRenderer *gtk_cifro_scope_renderer_new                    (GtkCifroArea          *area);

/* Функция устанавливает раскладку шрифта для отображения текстовых надписей в осциллографе. */
void                   gtk_cifro_scope_renderer_set_font               (GtkCifroScopeRenderer *scope_renderer,
                                                                        PangoLayout           *font);

/* Функция устанавливает основной цвет для отображения графических элементов в осциллографе. */
void                   gtk_cifro_scope_renderer_set_fg_color           (GtkCifroScopeRenderer *scope_renderer,
                                                                        gdouble                red,
                                                                        gdouble                green,
                                                                        gdouble                blue,
                                                                        gdouble                alpha);
...
void                   gtk_cifro_scope_renderer_set_pointer            (GtkCifroScopeRenderer *scope_renderer,
                                                                        gint                   pointer_x,
                                                                        gint                   pointer_y);

/* Функция включает или выключает отображения блока с информацией о значениях под курсором. */
void                   gtk_cifro_scope_renderer_set_info_show          (GtkCifroScopeRenderer *scope_renderer,
                                                                        gboolean               show);

/* Функция задаёт подписи к осям абсцисс и ординат. */
void                   gtk_cifro_scope_renderer_set_axis_name          (GtkCifroScopeRenderer *scope_renderer,
...
void                   gtk_cifro_scope_renderer_remove_channel         (GtkCifroScopeRenderer *scope_renderer,
                                                                        gpointer               channel_id);

/* Функция устанавливает имя канала. */
void                   gtk_cifro_scope_renderer_set_channel_name       (GtkCifroScopeRenderer *scope_renderer,
                                                                        gpointer               channel_id,
                                                                        const gchar           *axis_name);

/* Функция устанавливает с какого момента времени следует отображать данные
   и шаг между двумя соседними данными. */
void                   gtk_cifro_scope_renderer_set_channel_time_param (GtkCifroScopeRenderer *scope_renderer,
                                                                        gpointer               channel_id,
                                                                        gfloat                 time_shift,
                                                                        gfloat                 time_step);

/* Функция устанавливает коэффициенты на которые умножаются и сдвигаются все данные в канале. */
void                   gtk_cifro_scope_renderer_set_channel_value_param(GtkCifroScopeRenderer *scope_renderer,
                                                                        gpointer               channel_id,
                                                                        gfloat                 value_shift,
                                                                        gfloat                 value_scale);

/* Функция устанавливает типа отображения осциллограмм. */
void                   gtk_cifro_scope_renderer_set_channel_draw_type  (GtkCifroScopeRenderer *scope_renderer,
                                                                        gpointer               channel_id,
                                                                        GtkCifroScopeDrawType  draw_type);

/* Функция устанавливает цвет отображения данных канала. */
void                   gtk_cifro_scope_renderer_set_channel_color      (GtkCifroScopeRenderer *scope_renderer,
                                                                        gpointer               channel_id,
                                                                        gdouble                red,
                                                                        gdouble                green,
                                                                        gdouble                blue);
...
void                   gtk_cifro_scope_renderer_set_channel_data       (GtkCifroScopeRenderer *scope_renderer,
                                                                        gpointer               channel_id,
                                                                        gint                   num,
                                                                        gfloat                *values);

/* Функция включает или выключает отображения данных канала. */
void                   gtk_cifro_scope_renderer_set_channel_show       (GtkCifroScopeRenderer *scope_renderer,
                                                                        gpointer               channel_id,
                                                                        gboolean               show);
...
#endif /* __GTK_CIFRO_SCOPE_RENDERER_H__ */
