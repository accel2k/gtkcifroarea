...
#ifndef __GTK_CIFRO_CURVE_RENDERER_H__
#define __GTK_CIFRO_CURVE_RENDERER_H__
...
typedef struct _GtkCifroCurveRenderer GtkCifroCurveRenderer;
typedef struct _GtkCifroCurveRendererPrivate GtkCifroCurveRendererPrivate;
typedef struct _GtkCifroCurveRendererClass GtkCifroCurveRendererClass;

struct _GtkCifroCurveRenderer
{
...
struct _GtkCifroCurveRendererClass
{
...
GtkCifroCurveRenderer *gtk_cifro_curve_renderer_new                    (GtkCifroArea          *area,
...
void                   gtk_cifro_curve_renderer_add_point              (GtkCifroCurveRenderer *curve_renderer,
                                                                        gdouble                x,
                                                                        gdouble                y);

/* Функция устанавливает новые контрольные точки взамен текущих. */
void                   gtk_cifro_curve_renderer_set_points             (GtkCifroCurveRenderer *curve_renderer,
                                                                        GArray                *points);
...
void                   gtk_cifro_curve_renderer_set_curve_color        (GtkCifroCurveRenderer *curve_renderer,
                                                                        gdouble                red,
                                                                        gdouble                green,
                                                                        gdouble                blue);

/* Функция устанавливает цвет контрольных точек кривой. */
void                   gtk_cifro_curve_renderer_set_point_color        (GtkCifroCurveRenderer *curve_renderer,
                                                                        gdouble                red,
                                                                        gdouble                green,
                                                                        gdouble                blue);

/* Функция обработки сигнала нажатия кнопки мыши.
   Должна быть подключена к сигналу "button-press-event". */
gboolean               gtk_cifro_curve_renderer_button_press_event     (GtkWidget             *widget,
                                                                        GdkEventButton        *event,
                                                                        GtkCifroCurveRenderer *curve_renderer);

/* Функция обработки сигнала отпускания кнопки мыши.
   Должна быть подключена к сигналу "button-release-event". */
gboolean               gtk_cifro_curve_renderer_button_release_event   (GtkWidget             *widget,
                                                                        GdkEventButton        *event,
                                                                        GtkCifroCurveRenderer *curve_renderer);

/* Функция обработки сигнала движения мышки.
   Должна быть подключена к сигналу "motion-notify-event". */
gboolean               gtk_cifro_curve_renderer_motion_notify_event    (GtkWidget             *widget,
                                                                        GdkEventMotion        *event,
                                                                        GtkCifroCurveRenderer *curve_renderer);

G_END_DECLS

#endif /* __GTK_CIFRO_CURVE_RENDERER_H__ */
