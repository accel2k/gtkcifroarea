...
typedef struct cairo_sdline_surface {            // Структура описания поверхности для рисования.
...
guint32 cairo_sdline_color( gdouble red, gdouble green, gdouble blue, gdouble alpha );
