...
if (${GTKDOC_SCAN_EXE} STREQUAL GTKDOC_SCAN_EXE-NOTFOUND)
  message (FATAL_ERROR "gtkdoc-scan not found")
endif ()

if (${GTKDOC_SCANGOBJ_EXE} STREQUAL GTKDOC_SCANGOBJ_EXE-NOTFOUND)
  message (FATAL_ERROR "gtkdoc-scangobj not found")
endif ()

if (${GTKDOC_MKDB_EXE} STREQUAL GTKDOC_MKDB_EXE-NOTFOUND)
  message (FATAL_ERROR "gtkdoc-mkdb not found")
endif ()

if (${GTKDOC_MKHTML_EXE} STREQUAL GTKDOC_MKHTML_EXE-NOTFOUND)
  message (FATAL_ERROR "gtkdoc-mkhtml not found")
endif ()

if (${GTKDOC_FIXXREF_EXE} STREQUAL GTKDOC_FIXXREF_EXE-NOTFOUND)
